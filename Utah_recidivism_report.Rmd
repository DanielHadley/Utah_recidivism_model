...
# Average
monthly_average_OUP_cost <- monthly_ER_cost + monthly_DWS_DHS_costs + monthly_shelter_cost 
...
# So we came up with a distribution based on the monthly average + imagined outliers
...
unif_Base <- rtruncpareto(6000, 50, 25000, .6)
