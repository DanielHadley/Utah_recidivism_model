...
These tables do not fully show the effect the super-utilizers have on cost. It is reasonable to assume that with super utilizers there will be a discernable gap between the average and mean cost per individual.  
