...
ggplot() + 
  ...
  scale_colour_manual(name="Cost Reduction", values=c("r" = "red", "b"="blue","g"="green","o"="orange"), labels=c("b"="blue values", "r"="red values")) +
  scale_fill_manual(name="Cost Reduction", values=c("r" = "red", "b"="blue","g"="green","o"="orange"), labels=c("b"="Base", "r"="Low","g"="Medium","o"="High"))
