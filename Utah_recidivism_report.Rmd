...
ambulance <- 1200
ER <- 1200
calc_combined_cost<-function(){
  unif<-as.list(c(rgeom(58500,.0019),runif(1500,5000,35000)))
  sample<-sample(unif,1)
...
sim_single_agent <- function(months) {
  ...
  for (month in 1:months) {
    ...
    m.total_combined_costs<-calc_combined_cost()
...
for (i in sensitivity_recid_reductions) {
  ...
  multi_agent_post <- sim_multi_agents(n_agents = 10, n_months = 60)
