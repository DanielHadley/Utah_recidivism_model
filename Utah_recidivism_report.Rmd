...
ggplot(multi_agent, aes(avg_total_cost_per_yr)) + 
  geom_histogram(fill="#c0392b", alpha=0.75, color = "white", bins = 50) +
  labs(title = "Histogram of Annual Costs", y = "# of Simulations", x = "Average Total Cost Per Year") +
  scale_x_continuous(labels=dollar)
```

```{r cost low, echo=FALSE}
# plot the hist
ggplot(multi_agent_low, aes(avg_total_cost_per_yr)) + 
  geom_histogram(fill="#c0392b", alpha=0.75, color = "white", bins = 50) +
  labs(title = "Histogram of Annual Costs Low", y = "# of Simulations", x = "Average Total Cost Per Year") +
  scale_x_continuous(labels=dollar)
```

```{r cost med, echo=FALSE}
# plot the hist
ggplot(multi_agent_med, aes(avg_total_cost_per_yr)) + 
  geom_histogram(fill="#c0392b", alpha=0.75, color = "white", bins = 50) +
  labs(title = "Histogram of Annual Costs Medium", y = "# of Simulations", x = "Average Total Cost Per Year") +
  scale_x_continuous(labels=dollar)
```

```{r cost high, echo=FALSE}
# plot the hist
ggplot(multi_agent_high, aes(avg_total_cost_per_yr)) + 
  geom_histogram(fill="#c0392b", alpha=0.75, color = "white", bins = 50) +
  labs(title = "Histogram of Annual Costs High", y = "# of Simulations", x = "Average Total Cost Per Year") +
  scale_x_continuous(labels=dollar)
...
table<-data_frame(c("Base","Low","Median","High"),
                  ...
                  ,c(dollar(mean(multi_agent$total_costs)),
                     dollar(mean(multi_agent_low$total_costs)),
                    dollar(mean(multi_agent_med$total_costs)),
                    dollar(mean(multi_agent_high$total_costs)))
                  )
